...
/**
 * `/account` — the four things a person owns about their account: the name it
 * shows, the password it opens with, the other ways in, and the browsers it is
 * open in.
 *
 ...
 * panel inside the page's panel makes it read as four unrelated screens
    ...
    <main className="mx-auto flex w-full max-w-2xl flex-col px-4 py-6 sm:px-6 sm:py-10">
      <header className="flex flex-col gap-1">
        ...
        <p className="text-[13px] text-ink-3">
          Your details, your password, how you sign in, and the devices holding a session.
        </p>
      </header>
